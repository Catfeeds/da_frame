...
<script type="text/javascript" src="../Public/resource/common/js/jquery.validation.min.js"></script>
<script type="text/javascript" src="../Public/resource/common/js/jquery.icheck.min.js"></script>
    ...
    <div class="form-box control-group">
      <fieldset>
        ...
        <div>
          <label>数据库名</label>
          <span>
          <input type="text" name="db_name" maxlength="50" value="<?php echo $_POST['db_name'] ? $_POST['db_name'] : 'shopda';?>">
          </span> <em></em></div>
        <div>
          <label>数据库用户名</label>
          <span>
        ...
        <div>
          <label>数据库表前缀</label>
          <span>
          <input type="text" name="db_prefix" maxlength="30" value="<?php echo $_POST['db_prefix'] ? $_POST['db_prefix'] : 'shopda_';?>">
          </span> <em>同一数据库运行多个大商城程序时，请修改前缀</em></div>
        <div>
          <label>数据库端口</label>
          <span>
        ...
        <div>
          <label>&nbsp;</label>
          <input name="https_open" type="checkbox" id="https_open" value="1" <?php echo (($_POST['https_open']==1) ? 'checked':'');?>>
        <h4>开启HTTPS</h4></div>
