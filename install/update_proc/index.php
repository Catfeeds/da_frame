...
function runquery($sql) {
	...
	$sql = str_replace("\r", "\n", str_replace('shopda_', $tablepre, $sql));
	$ret = array();
	$num = 0;
	foreach(explode(";\n", trim($sql)) as $query) {
		$ret[$num] = '';
...
<link href="install.css" rel="stylesheet" type="text/css">
	...
	<div class="header">
      <div class="layout">
        ...
        <div class="version">版本: 2017.03.20</div>
      </div>
	</div>
	<table class="menu" align="center">
			<tr class="menu_tr">
				...
				<?php if ($current == ''){ ?>
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;如果你的版本里未安装www.shopda.cn模块！你只需简单一步就可以安装好大商城 升级包了哦！感谢你对大商城 的支持！<span style="color: #FF0000;">如因安装造成您原有二次开发功能的错误或丢失，www.shopda.cn不予承担任何责任及损失，请您慎重操作。
				</span><br /><br />
			  ...
			  <div>
			  	...
			  	2、&nbsp;&nbsp;本模板只用于学习交流使用。无论您是个人组织、盈利与否、用途如何（包括以学习和研究为目的），均与大商城无关！<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大商城只提供相关技术服务！不负责任何商业责任！还请知悉。<br />
			  	3、&nbsp;&nbsp;大商城官方论坛：http://www.shopda.cn<br />
...
<div class="footer">
  <h5><a href="http://www.shopda.cn" target="_blank">www.shopda.cn</a></h6>
</div>
<script type="text/javascript">
<?php if ($_GET['go'] == '3'){ ?>
