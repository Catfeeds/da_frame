...
<div class="main">
  ...
  <div class="final-site-nav">
    ...
    <ul>
      <li class="shop">
        <div class="ico"></div>
        <h5><a href="<?php echo substr($auto_site_url,0,-8);?>/index.php?m=Shop" target="_blank">商城</a></h5>
        <h6>线上购物、开店、交易...</h6>
      </li>
      <li class="cms">
        <div class="ico"></div>
        <h5><a href="<?php echo substr($auto_site_url,0,-8);?>/index.php?m=Cms" target="_blank">资讯</a></h5>
        <h6>CMS资讯、画报、专题...</h6>
      </li>
      <li class="circle">
        <div class="ico"></div>
        <h5><a href="<?php echo substr($auto_site_url,0,-8);?>/index.php?m=Circle" target="_blank">圈子</a></h5>
        <h6>主题、圈友、商品...</h6>
      </li>
      <li class="microshop">
        <div class="ico"></div>
        <h5><a href="<?php echo substr($auto_site_url,0,-8);?>/index.php?m=MicroShop" target="_blank">微商城</a></h5>
        <h6>随心看、个人秀、店铺街</h6>
      </li>
      <li class="admin">
        <div class="ico"></div>
        <h5><a href="<?php echo substr($auto_site_url,0,-8);?>/admin.php" target="_blank">系统管理</a></h5>
        <h6>电商系统后台</h6>
      </li>
    </ul>
  </div>
  <div class="final-intro">
    <p><strong>系统管理默认地址:&nbsp;</strong><a href="<?php echo substr($auto_site_url,0,-8);?>/admin.php" target="_blank"><?php echo substr($auto_site_url,0,-8);?>/admin.php</a></p>
