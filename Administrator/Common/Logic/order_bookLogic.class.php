            ...
            if (empty($book_list[0]['book_pay_time'])) {
                ...
                if ($book_list[0]['book_end_time'] > TIMESTAMP) {
                    ...
                    if ($order_info['order_state'] == ORDER_STATE_CANCEL) {
						...
						$buy_url = url('buy', 'pay', array('pay_sn' => $pay_sn));
						
                        $book_list[0]['book_operate'] = '<a class="spdm-btn spdm-btn-orange fr mr15" href="'.$buy_url.'">付款</a>';
                    ...
                    $book_list[0]['book_amount_ext'] = '(含定金'.daPriceFormat($book_list[0]['book_deposit_amount']).')';
                } else {
                    //已过期
                ...
                if (empty($book_list[1]['book_pay_time'])) {
                    ...
                    if ($book_list[1]['book_end_time'] > TIMESTAMP) {
                        ...
                        if ($order_info['order_state'] == ORDER_STATE_CANCEL) {
						    ...
						    $buy_url = url('buy', 'pay', array('pay_sn' => $pay_sn));
                            $book_list[1]['book_operate'] = '<a class="spdm-btn spdm-btn-orange fr mr15"  href="' . $buy_url . '">付款</a>';
