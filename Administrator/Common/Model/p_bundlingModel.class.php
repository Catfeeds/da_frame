                    ...
                    if (!empty($b_goods_list) && count($b_goods_list) > 1) {
                        ...
                        foreach ( $b_goods_list as $val ) {
                            if (isset($goods_list[$val['goods_id']])) {
                                ...
                                $b_goods_array[$val['bl_id']][$k]['shop_price'] = daPriceFormat($goods_list[$val['goods_id']]['goods_price']);
                                $b_goods_array[$val['bl_id']][$k]['price'] = daPriceFormat($val['bl_goods_price']);
