                    ...
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array('goods_id'=>$data['goods_id'])) . "\"><img src=\"" . cthumb($data['goods_image'], 240, $data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['goods_name'] . "\"></a></div>
                        ...
                        <dl>
                           <dt><i class=\"desc-type desc-type-new\">" . L('store_sns_new_selease') . "</i><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array('goods_id'=>$data['goods_id'])) . "\">" . $data['goods_name'] . "</a></dt>
                            <dd>" . L('sns_sharegoods_price') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_price']) . "</dd>
                            <dd>" . ($data['goods_transfee_charge'] == '1' ? L('store_sns_free_shipping') : L('sns_sharegoods_freight') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_freight'])) . "</dd>
                            <dd datype=\"collectbtn_" . $data['goods_id'] . "\"><a href=\"javascript:void(0);\" onclick=\"javascript:collect_goods('" . $data['goods_id'] . "','succ','collectbtn_" . $data['goods_id'] . "');\">" . L('sns_sharegoods_collect') . "</a></dd>
                        </dl>
                      </div>
                 </div>";
                break;
                ...
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('coupon_store', 'detail', array('coupon_id' => $data['coupon_id'], 'id' => $data['store_id'])) . "\"><img src=\"" . $data['coupon_pic'] . "\" onerror=\"this.src='" . SHOP_TEMPLATES_URL . "/images/default_coupon_image.png'\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['coupon_title'] . "\"></a></div>
                        ...
                        <dl>
                            ...
                            <dd>" . L('store_sns_coupon_price') . L('spd_colon') . L('currency') . daPriceFormat($data['coupon_price']) . "</dd>
                            <dd>" . L('store_sns_start-stop_time') . L('spd_colon') . date('Y-m-d H:i', $data['coupon_start_date']) . "~" . date('Y-m-d H:i', $data['coupon_end_date']) . "</dd>
                        </dl>
                      </div>
                    </div>";
                break;
                ...
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array('goods_id'=>$data['goods_id'])) . "\"><img src=\"" . cthumb($data['goods_image'], 240,$data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['goods_name'] . "\"></a></div>
                        ...
                        <dl>
                            ...
                            <dd>" . L('sns_sharegoods_price') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_price']) . "</dd>
                            <dd>" . L('store_sns_formerprice') . L('spd_colon') . L('currency') . daPriceFormat($data['xianshi_price']) . "</dd>
                            <dd datype=\"collectbtn_" . $data['goods_id'] . "\"><a href=\"javascript:void(0);\" onclick=\"javascript:collect_goods('" . $data['goods_id'] . "','succ','collectbtn_" . $data['goods_id'] . "');\">" . L('sns_sharegoods_collect') . "</a></dd>
                        </dl>
                      </div>
                     </div>";
                ...
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('show_store', 'index', array('store_id'=>$data['store_id'])) . "\"><img src=\"" . SHOP_TEMPLATES_URL . "/images/mjs-pic.gif\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"".$data['ansong_name']."\"></a></div>
                        ...
                        <dl>
                            ...
                            <dd>" . L('store_sns_start-stop_time') . L('spd_colon') . date('Y-m-d H:i', $data['start_time']) . "~" . date('Y-m-d H:i', $data['end_time']) . "</dd>
                        </dl>
                        </div>
                     </div>";
                 break;
                ...
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array('goods_id'=>$data['goods_id'])) . "\"><img src=\"" . cthumb($data['bl_img'], 240, $data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['bl_name'] . "\"></a></div>
                        ...
                        <dl>
                            ...
                            <dd>" . L('store_sns_bundling_price') . L('spd_colon') . L('currency') . daPriceFormat($data['bl_discount_price']) . "</dd>
                            <dd>" . (($data['bl_freight_choose']==1) ? L('store_sns_free_shipping') : L('sns_sharegoods_freight') . L('spd_colon') . L('currency') . daPriceFormat($data['bl_freight'])) . "</dd>
                        </dl>
                    </div>
                    </div>";
                break;
                ...
                $rs = "<div class=\"fd-media\">
                    <div class=\"goodsimg\"><a target=\"_blank\" href=\"" . urlShop('goods', 'index', array('goods_id'=>$data['goods_id'])) . "\"><img src=\"" . gthumb($data['group_pic'],'small',$data['store_id']) . "\" onload=\"javascript:DrawImage(this,120,120);\" alt=\"" . $data['group_name'] . "\"></a></div>
                        ...
                        <dl>
                            ...
                            <dd>" . L('store_sns_goodsprice') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_price']) . "</dd>
                            <dd>" . L('store_sns_groupprice') . L('spd_colon') . L('currency') . daPriceFormat($data['groupbuy_price']) . "</dd>
                            <dd>" . L('store_sns_start-stop_time') . L('spd_colon') . date('Y-m-d H:i', $data['start_time']) . "~" . date('Y-m-d H:i', $data['end_time']) . "</dd>
                        </dl>
                    </div>
                </div>";
            ...
            case '9':
                $rs = "<div class=\"fd-media\">
                    ...
                    <dl>
                        ...
                        <dd>" . L('sns_sharegoods_price') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_price']) . "</dd>
                        <dd>" . L('sns_sharegoods_freight') . L('spd_colon') . L('currency') . daPriceFormat($data['goods_freight']) . "</dd>
                        <dd datype=\"collectbtn_" . $data['goods_id'] . "\"><a href=\"javascript:void(0);\" onclick=\"javascript:collect_goods('" . $data['goods_id'] . "','succ','collectbtn_" . $data['goods_id'] . "');\">" . L('sns_sharegoods_collect') . "</a></dd>
                    </dl>
                    </div>
                 </div>";
