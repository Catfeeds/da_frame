...
class GroupbuyController extends SystemController {

    public function __construct(){
        parent::__construct();
        Language::read('groupbuy', 'Home');
        ...
        if (C('groupbuy_allow') != 1){
            $url = array(
                ...
                array(
                    'url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=groupbuy_template_list&groupbuy_open=1',
    ...
    public function groupbuy_list()
    {
        ...
        $this->render('groupbuy.list');
    }

    public function groupbuy_list_xml()
    {
        $condition = array();
        ...
        foreach ($groupbuy_list as $val) {
            $u = SHOP_SITE_URL . "&c=ShowGroupbuy&a=groupbuy_detail&group_id=" . $val['groupbuy_id'];
            ...
            $i['goods_name'] = '<a target="_blank" href="'
                . SHOP_SITE_URL . "&c=Goods&goods_id=" . $val['goods_id']
                . '">' . $val['goods_name'] . '</a>';
...
EOB;
    ...
    public function class_sort_update()
    {
        $update_array = array();
        $where_array = array();
    ...
    public function groupbuy_quota()
    {
		...
		$this->setDirquna('shop');
        $this->render('groupbuy_quota.list');
    }

    /**
     * 套餐管理
     */
    public function groupbuy_quota_xml()
    {
        $condition = array();
    ...
    public function class_list() {
		...
		$this->setDirquna('shop');
        $this->render('groupbuy_class.list');
    }
    ...
    public function class_add() {
		...
		$this->setDirquna('shop');
        $this->render('groupbuy_class.add');
    ...
    public function class_save() {
        ...
        if(empty($class_id)) {
            ...
            if ($class_id = $model_groupbuy_class->save($param)) {
                ...
                showMessage(Language::get('groupbuy_class_add_success'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_add_fail'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_list');
            }
        }
        else {
            //编辑
            if($model_groupbuy_class->updates($param,array('class_id'=>$class_id))) {
                ...
                showMessage(Language::get('groupbuy_class_edit_success'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_list');
            }
            else {
                showMessage(Language::get('groupbuy_class_edit_fail'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_list');
            }
        }
    ...
    public function price_list()
    {
		...
		$this->setDirquna('shop');
        $this->render('groupbuy_price.list');
    }

    /**
     * 抢购价格区间列表
     */
    public function price_list_xml()
    {
        ...
        foreach ($groupbuy_price_list as $val) {
            $o = '<a class="confirm-del-on-click btn red" href="' . $GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_drop&range_id='
                . $val['range_id']
                . '"><i class="fa fa-trash-o"></i>删除</a>';
            $o .= '<a class="btn blue" href="' . $GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_edit&range_id='
                . $val['range_id']
    ...
    public function price_add() {
		...
		$this->setDirquna('shop');
        $this->render('groupbuy_price.add');
    ...
    public function price_save() {
        ...
        if(empty($range_id)) {
            ...
            if($model->save($param)) {
                ...
                showMessage(Language::get('groupbuy_price_range_add_success'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_add_fail'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_list');
            }
        }
        else {
            //编辑
            if($model->updates($param,array('range_id'=>$range_id))) {
                ...
                showMessage(Language::get('groupbuy_price_range_edit_success'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_list');
            }
            else {
                showMessage(Language::get('groupbuy_price_range_edit_fail'),$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_list');
            }
        }
    ...
    private function show_menu($menu_key) {
        $menu_array = array(
            'groupbuy_list'=>array('menu_type'=>'link','menu_name'=>'抢购活动','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=groupbuy_list'),
            'groupbuy_quota'=>array('menu_type'=>'link','menu_name'=>'套餐管理','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=groupbuy_quota'),
            'class_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_list'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_list'),
            'class_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_class_add'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=class_add'),
            'price_list'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_list'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_list'),
            'price_add'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_add'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_add'),
            'price_edit'=>array('menu_type'=>'link','menu_name'=>Language::get('groupbuy_price_edit'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=Groupbuy&a=price_edit'),
