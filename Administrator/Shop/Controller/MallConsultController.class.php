...
class MallConsultController extends SystemController {
    ...
    public function index(){
        ...
        $this->render('mall_consult.index');
    }
    ...
    public function get_xml(){
        ...
        foreach ($consult_list as $consult_info) {
            ...
            if ($consult_info['is_reply']) {
                $list['operation'] .= "<a class=\"btn green\" href=\"{$GLOBALS['_PAGE_URL']}&c=MallConsult&a=consult_reply&id={$consult_info['mc_id']}\"><i class=\"fa fa-list-alt\"></i>编辑</a>";
            } else {
                $list['operation'] .= "<a class=\"btn green\" href=\"{$GLOBALS['_PAGE_URL']}&c=MallConsult&a=consult_reply&id={$consult_info['mc_id']}\"><i class=\"fa fa-list-alt\"></i>回复</a>";
            }
    ...
    public function consult_reply() {
		...
		$this->setDirquna('shop');
        $this->render('mall_consult.reply');
    }
    ...
    public function type_list() {
        ...
        $this->assign('type_list', $type_list);
		$this->setDirquna('shop');
        $this->render('mall_consult.type_list');
    }
    ...
    public function type_add() {
        if (chksubmit()) {
            ...
            if ($result){
                $this->log('新增咨询类型',1);
                showMessage(L('spd_common_save_succ'), urlAdminShop('mall_consult', 'type_list'));
            }else {
                $this->log('新增咨询类型',0);
		...
		$this->setDirquna('shop');
        $this->render('mall_consult.type_add');
    }
    ...
    public function type_edit() {
        ...
        if (chksubmit()) {
            ...
            if ($result){
                ...
                showMessage(L('spd_common_op_succ'), urlAdminShop('mall_consult', 'type_list'));
            }else {
		...
		$this->setDirquna('shop');
        $this->render('mall_consult.type_edit');
    }
