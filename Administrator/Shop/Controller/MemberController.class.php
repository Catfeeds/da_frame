...
class MemberController extends SystemController {
    ...
    public function get_xml() {
        ...
        foreach ($member_list as $value) {
            ...
            $param['available_predeposit'] = daPriceFormat($value['available_predeposit']);
            $param['freeze_predeposit'] = daPriceFormat($value['freeze_predeposit']);
            $param['available_rc_balance'] = daPriceFormat($value['available_rc_balance']);
            $param['freeze_rc_balance'] = daPriceFormat($value['freeze_rc_balance']);
