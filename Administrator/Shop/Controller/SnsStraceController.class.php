...
class SnsStraceController extends SystemController {
    public function __construct(){
        parent::__construct();
        Language::read('snstrace,sns_strace', 'Home');
    }
     ...
     * 动态列表
     */
    public function stracelist(){
		$this->setDirquna('shop');
        $this->render('sns_strace.index');
    }
    ...
    public function get_xml() {
        ...
        foreach ($strace_list as $value) {
            ...
            $operation .= "<li><a href='{$GLOBALS['_PAGE_URL']}&c=SnsStrace&a=scomm_list&st_id=". $value['strace_id'] ."'>查看评论</a></li>";
    ...
    public function strace_info() {
		...
		$this->setDirquna('shop');
        $this->render('sns_strace.info', 'null_layout');
    }
    ...
    public function scomm_list(){
		...
		$this->setDirquna('shop');
        $this->render('sns_scomment.index');
    }

    /**
     * 输出XML数据
     */
    public function get_scomm_xml() {
     ...
     * 评论详细
     */
    public function scomm_info() {
        $model_scomment = Model('store_sns_comment');
        $id = $_GET['id'];
        $scomm_info = $model_scomment->getStoreSnsCommentInfo(array('scomm_id' => $id));
        $this->assign('scomm_info', $scomm_info);
		$this->setDirquna('shop');
        $this->render('sns_scomment.info', 'null_layout');
    }
