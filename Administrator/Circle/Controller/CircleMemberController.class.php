...
class CircleMemberController extends SystemController {
...
$this->render('circle_member.list');
    }
    ...
    public function get_xml() {
        ...
        foreach ($member_list as $value) {
            ...
            $operation .= "<li><a href='".SHOP_SITE_URL."&c=SnsCircle&mid=".$value['member_id']."' target=\"_blank\">查看成员信息</a></li>";
