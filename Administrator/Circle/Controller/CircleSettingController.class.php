...
class CircleSettingController extends SystemController {
    ...
    public function index(){
        ...
        if(chksubmit()){
            ...
            if($result){
                ...
                if(intval($_POST['c_isuse']) == 1){
                    $this->log(L('spd_circle_open'));
                }else{
                    $this->log(L('spd_circle_close'));
                }
        ...
        $this->render('circle_setting.index');
    }
    /**
     * SEO 设置
     */
    public function seo(){
        ...
        $this->assign('list_setting',$list_setting);
        $this->setDirquna('circle');
$this->render('circle_setting.seo');
    }
    /**
     * SEC 设置
     */
    public function sec(){
        ...
        $this->assign('list_setting',$list_setting);
        $this->setDirquna('circle');
$this->render('circle_setting.sec');
    }
    /**
     * 成员等级
     */
    public function exp(){
        ...
        $this->assign('list_setting',$list_setting);
        $this->setDirquna('circle');
$this->render('circle_setting.exp');
    }
    /**
     * 圈子首页广告
     */
    public function adv_manage(){
        ...
        $this->setDirquna('circle');
$this->render('circle_setting.adv');
    }
    ...
    public function superadd() {
        if (chksubmit()) {
            ...
            if ($result) {
                showMessage(L('spd_common_op_succ'), urlAdminCircle('circle_setting', 'super_list'));
            } else {
                showMessage(L('spd_common_op_fail'));
            }
        }
        $this->setDirquna('circle');
$this->render('circle_setting.super_add');
    }

    /**
     * 超级管理列表
     */
    public function super_list() {
        ...
        $this->setDirquna('circle');
$this->render('circle_setting.super_list');
    }

    /**
     * 选择超管
     */
    public function choose_super(){
        $this->assign('search_url', urlAdminCircle('circle_setting', 'member_search'));
        $this->setDirquna('circle');
