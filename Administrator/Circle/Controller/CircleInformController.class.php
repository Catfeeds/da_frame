...
class CircleInformController extends SystemController {
    public function __construct(){
        parent::__construct();
        Language::read('circle_inform', 'Home');
    }
...
$this->render('circle_inform');
    ...
    private function spellInformUrl($param){
        if($param['reply_id'] == 0) return $url = $GLOBALS['_PAGE_URL'] . '&c=Theme&a=theme_detail&c_id='.$param['circle_id'].'&t_id='.$param['theme_id'];
