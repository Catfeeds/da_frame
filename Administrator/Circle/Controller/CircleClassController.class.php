...
class CircleClassController extends SystemController {
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($result){
                    $url = array(
                        array(
                            'url'=>$GLOBALS['_PAGE_URL'] . '&c=CircleClass&a=class_add',
                            'msg'=>L('circle_continue_add'),
                        ),
                        array(
                            'url'=>$GLOBALS['_PAGE_URL'] . '&c=CircleClass&a=class_list',
    ...
    public function class_edit(){
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($result){
                    showMessage(L('spd_common_op_succ'),$GLOBALS['_PAGE_URL'] . '&c=CircleClass&op=class_list');
                }else{
                    showMessage(L('spd_common_op_fail'));
                }
            }
