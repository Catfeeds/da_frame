        ...
        if(chksubmit()){
            ...
            if ($error != ''){
                ...
                if ($result){
                    ...
                    $url = array(
                        array(
                            'url'=>$GLOBALS['_PAGE_URL'] . '&c=Document&a=document',
                            'msg'=>$lang['document_edit_back_to_list']
                        ),
                        array(
                            'url'=>$GLOBALS['_PAGE_URL'] . '&c=Document&a=edit&doc_id='.intval($_POST['doc_id']),
                            'msg'=>$lang['document_edit_again']
                        ),
                    );
                    $this->log(L('spd_edit,document_index_document').'[ID:'.$_POST['doc_id'].']',1);
