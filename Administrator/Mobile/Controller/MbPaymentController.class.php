...
class MbPaymentController extends SystemController {
    ...
    public function payment_edit() {
        ...
        $this->assign('config_array', $mb_payment_info['payment_config']);
        $this->setDirquna('mobile');
        $this->render('mb_payment.edit');
    }
    ...
    public function payment_save() {
        ...
        $payment_config = array_merge($_POST, $payment_config);
        ...
        if($result) {
            showMessage(Language::get('spd_common_save_succ'), urlAdminMobile('mb_payment', 'payment_list'));
        } else {
            showMessage(Language::get('spd_common_save_fail'), urlAdminMobile('mb_payment', 'payment_list'));
        }
    }
}
