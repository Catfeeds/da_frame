...
class MircroShopController extends Controller{
    ...
    public function __construct(){
         ...
         * 设置布局文件内容
         */
        $this->setLayout('microshop_layout');
        /**
         * 转码
         */
         ...
         */
        $search_type = array();
        $search_type['goods'] = Language::get('spd_microshop_goods');
        $search_type['personal'] = Language::get('spd_microshop_personal');
         ...
         * seo
         */
        $this->assign('html_title',Language::get('spd_microshop').'-'.C('site_name'));
        $this->assign('seo_keywords',C('microshop_seo_keywords'));
        $this->assign('seo_description',C('microshop_seo_description'));
...
//     	exit;
        if(!isset($_SESSION['is_login'])) {
            @header("location: " . urlLogin('login', 'index', array('ref_url' => $referUrl)));die;
        }
    }
    ...
    protected function get_personal_class_list() {
        ...
        $this->assign('personal_class_list',$list);
    }
    ...
    protected function get_goods_list($condition,$order='commend_time desc') {
        ...
        $this->assign('show_page',$model_microshop_goods->showpage(2));
...
//         var_dump($list);
    ...
    protected function share_app_publish($type,$publish_info=array()) {
        ...
        switch ($type) {
        case 'comment':
            $param['comment'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_comment').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_comment').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            break;
        case 'publish':
            $param['comment'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_commend').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_commend').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            break;
        case 'share':
            $param['comment'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_share').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            $param['title'] = "'".$_SESSION['member_name']."'".Language::get('microshop_text_zai').Language::get('spd_microshop').Language::get('microshop_text_share').Language::get('microshop_text_le').Language::get("spd_microshop_{$publish_info['type']}_content");
            break;
        }
    ...
    protected function get_share_app_goods_content($goods_info,$param) {
        $content_str = "
            ...
            <dd>".Language::get('spd_common_price').Language::get('spd_colon').Language::get('currency').$goods_info['commend_goods_price']."</dd>
            <dd>{$param['comment']}<a target=\"_blank\" href=\"{$param['url']}\">".Language::get('spd_common_goto')."</a></dd>
            </dl>
            </div>
            </div>
            ";
    ...
    protected function get_share_app_personal_content($personal_info,$param) {
        ...
        $content_str .= "</ul><p>{$param['comment']}<a target=\"_blank\" href=\"{$param['url']}\">".Language::get('spd_common_goto')."</a></p>
            </div>
            </div>
            ";
        return $content_str;
    ...
    protected function get_sidebar_list($member_id) {
        ...
        $this->assign('sidebar_goods_list',$sidebar_goods_list);
        //个人秀
        ...
        $this->assign('sidebar_personal_list',$sidebar_personal_list);
    }
    ...
    protected function get_microshop_adv($type='index') {
        ...
        $this->assign($type.'_adv_list',$adv_list);
    }
