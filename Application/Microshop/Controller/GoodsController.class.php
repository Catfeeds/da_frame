...
class GoodsController extends MircroShopController{

    public function __construct() {
        parent::__construct();
        $this->assign('index_sign','goods');
    }
    ...
    public function lists() {
        ...
        $this->assign('goods_class_root_id',$goods_class_root_id);
        ...
        $this->assign('goods_class_menu',$goods_class_menu[$goods_class_root_id]);
        $this->assign('goods_class_menu_id',$goods_class_menu_id);
        ...
        $this->assign('html_title',Language::get('spd_microshop_goods').'-'.Language::get('spd_microshop').'-'.C('site_name'));
        $this->render('goods_list');
    ...
    public function detail() {
        ...
        $this->assign('goods_image_list', $goods_image_list);
        ...
        $this->assign('comment_id',$detail['commend_id']);
        $this->assign('comment_type','goods');
        $this->assign('html_title',$detail['commend_goods_name'].'-'.Language::get('spd_microshop_goods').'-'.Language::get('spd_microshop').'-'.C('site_name'));
        $this->render('goods_detail');
