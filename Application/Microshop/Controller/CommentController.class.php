...
class CommentController extends MircroShopController{
    ...
    public function comment_save() {
        ...
        if(!empty($_SESSION['member_id'])) {
            ...
            if($result) {
                ...
                $data['member_link'] = MICROSHOP_SITE_URL.'&c=Home&member_id='.$_SESSION['member_id'];
                ...
                if(isset($_POST['share_app_items'])) {
                    ...
                    $info['type'] = $_GET['type'];
                    $info['url'] = MICROSHOP_SITE_URL ."&c={$_GET['type']}&a=detail&{$_GET['type']}_id=".$_POST['comment_id'].'#widgetcommenttitle';
    ...
    public function comment_list() {
        ...
        if($comment_id > 0) {
            ...
            if(!empty($comment_type)) {
                ...
                $this->assign('show_page',$model_comment->showpage(2));
            }
        }
        $this->render('widget_comment_list','null_layout');
    }
