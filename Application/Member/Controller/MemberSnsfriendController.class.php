...
class MemberSnsfriendController extends BaseMemberController {
    ...
    public function find(){
        ...
        $this->render('member_snsfriend_find');
    }
    /**
     * 找人搜索列表
     */
    public function findlist(){
        ...
        self::profile_menu('find');
        $this->render('member_snsfriend_findlist');
    }
    /**
     * 加关注
     */
    ...
    public function follow() {
        ...
        $this->render('member_snsfriend_follow');
    }
    /**
     * 粉丝列表
     */
    public function fan() {
        ...
        $this->render('member_snsfriend_fan');
    }
    /**
     * 用户中心右边，小导航
     *
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
            1=>array('menu_key'=>'find',    'menu_name'=>Language::get('snsfriend_findmember'), 'menu_url'=> $GLOBALS['_PAGE_URL'] . '&c=MemberSnsfriend&a=find'),
            2=>array('menu_key'=>'follow',  'menu_name'=>Language::get('snsfriend_follow'), 'menu_url'=> $GLOBALS['_PAGE_URL'] . '&c=MemberSnsfriend&a=follow'),
            3=>array('menu_key'=>'fan',     'menu_name'=>Language::get('snsfriend_fans'),   'menu_url'=> $GLOBALS['_PAGE_URL'] . '&c=MemberSnsfriend&a=fan')
        );
