...
class ConnectQqController extends BaseLoginController{
    public function __construct(){
         ...
         */
        if (C('qq_isuse') != 1){
            showMessage(Language::get('home_qqconnect_unavailable'), $GLOBALS['_PAGE_URL'] ,'html','error');//'系统未开启QQ互联功能'
        }
        if (!empty($_GET['code'])){
