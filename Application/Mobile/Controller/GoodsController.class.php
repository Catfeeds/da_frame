...
class GoodsController extends MobileHomeController{
    ...
    private function _goods_list_extend($goods_list) {
        ...
        foreach ($goods_list as $key => $value) {
            ...
            unset($goods_list[$key]['spd_distinct']);
        }
    ...
    public function goods_detail() {
        ...
        $is_with_body = intval($_GET['is_with_body']);
        ...
        $goods_detail['goods_body'] = '';
        if ($is_with_body)
        {
        	$goods_body_html = $this->goods_body_html();
        	$goods_detail['goods_body'] = $goods_body_html;
        }
    ...
    public function goods_body() {
        ...
        $this->render('goods_body');
    }
    
    /**
     * 获取goods_body  html
     * */
    public function goods_body_html()
    {
    	header("Access-Control-Allow-Origin:*");
    	$goods_id = intval($_GET ['goods_id']);
    	...
    	$this->assign('goods_info', $goods_info);
    	$ret = $this->fetch_render('goods_body');
