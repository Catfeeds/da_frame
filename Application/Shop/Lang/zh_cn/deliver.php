...
$lang['store_deliver_express_note']			= '您可以通过"发货设置-><a href="' . $GLOBALS['_PAGE_URL'] . '&c=StoreDeliverSet&a=express" target="_parent" >默认物流公司</a>"添加或修改常用货运物流。免运可切换下方<span class="red">[无需物流运输服务]</span>选项卡并操作。';
