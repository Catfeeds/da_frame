...
$lang['store_deliver_express_note']			= '您可以通過"發貨設置-><a href="' . $GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=express" target="_parent" >預設物流公司</a>"添加或修改常用貨運物流。免運或自提商品可切換下方<span class="red">[無需物流運輸服務]</span>選項卡並操作。';
