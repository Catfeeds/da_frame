...
class StoreDecorationController extends BaseSellerController {
    ...
    public function decoration_setting() {
        ...
        $this->assign('is_own_shop', $this->store_info['is_own_shop']);
        $this->assign('left_bar_type', $this->store_info['left_bar_type']);
        $this->assign('decoration_id', $decoration_id);

        $this->profile_menu('decoration_setting');
        $this->render('store_decoration.setting');
    }
    ...
    public function decoration_album() {
        ...
        $this->assign('show_page',$model_store_decoration_album->showpage());

        $this->profile_menu('decoration_album');
        $this->render('store_decoration.album');
    }

    /**
     * 图片上传
     */
    public function decoration_album_upload() {
     ...
     * 图片删除
     */
    public function decoration_album_del() {
    ...
    public function decoration_edit() {
        ...
        $this->render('store_decoration.edit');
    }
     ...
     * 保存店铺装修背景设置
     */
    public function decoration_background_setting_save() {
     ...
     * 装修导航保存
     */
    public function decoration_nav_save() {
        $decoration_id = intval($_POST['decoration_id']);
        $nav = array();
     ...
     * 装修banner保存
     */
    public function decoration_banner_save() {
        $decoration_id = intval($_POST['decoration_id']);
        $banner = array();
     ...
     * 装修添加块
     */
    public function decoration_block_add() {
        $decoration_id = intval($_POST['decoration_id']);
        ...
        if($block_id) {
            ...
            $this->render('store_decoration_block', 'null_layout');
     ...
     * 装修块删除
     */
    public function decoration_block_del() {
     ...
     * 装修块保存
     */
    public function decoration_block_save() {
        $block_id = intval($_POST['block_id']);
     ...
     * 装修块排序
     */
    public function decoration_block_sort() {
    ...
    private function _get_block_html($content, $module_type) {
        ...
        $this->render('store_decoration_module.' . $module_type, 'null_layout');
        $temp = ob_get_contents();
        ob_end_clean();
        return $temp;
    }
    ...
    public function goods_search() {
        ...
        $this->render('store_decoration_module.goods', 'null_layout');
    }
    ...
    public function decoration_preview() {
        ...
        $this->render('store_decoration.preview');
    }
    ...
    public function decoration_build() {
        ...
        ob_start();
        $this->render('store_decoration.preview', 'null_layout');
