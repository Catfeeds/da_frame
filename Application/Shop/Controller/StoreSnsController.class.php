...
class StoreSnsController extends BaseSellerController{
    ...
    public function store_sns_save(){
        ...
        switch ($_POST['type']){
            case '2':
                ...
                if($sns_image != '') $content   = '<div class="fd-media">
                                    <div class="thumb-image"><a href="javascript:void(0);" spd_type="thumb-image"><img src="'.$sns_image.'" /><i></i></a></div>
                                    <div class="origin-image"><a href="javascript:void(0);" spd_type="origin-image"></a></div>
                                </div>';
                break;
            case '9':
        ...
        if($rs){
            showDialog(Language::get('spd_common_op_succ'), $GLOBALS['_PAGE_URL'] . '&c=StoreSns', 'succ');
        }else{
    ...
    private function profile_menu($menu_key) {
        $menu_array = array(
                1=>array('menu_key'=>'store_sns_add', 'menu_name'=>Language::get('store_sns_add'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreSns&a=add'),
                2=>array('menu_key'=>'store_sns_setting', 'menu_name'=>Language::get('store_sns_setting'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreSns&a=setting'),
