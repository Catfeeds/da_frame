...
class StoreDeliverController extends BaseSellerController {
    ...
    public function index() {
        ...
        $this->render('store_order.deliver');
    }
    ...
    public function send(){
        ...
        $this->render('store_deliver.send');
    }
    ...
    public function buyer_address_edit() {
        ...
        $this->render('store_deliver.buyer_address.edit','null_layout');
    }
    ...
    public function send_address_select() {
        ...
        $this->render('store_deliver.daddress.select','null_layout');
    }
    ...
    public function search_deliver(){
        ...
        $this->render('store_deliver.detail');
    }
    ...
    public function delay_receive(){
        ...
        if (chksubmit()) {
            ...
            $this->assign('order_info',$order_info);
            $this->render('store_deliver.delay_receive','null_layout');
            exit();
        }
    }
    ...
    public function waybill_print() {
        ...
        $this->render('waybill.print', 'null_layout');
    }
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'deliver':
                $menu_array = array(
                array('menu_key'=>'deliverno',          'menu_name'=>Language::get('spd_member_path_deliverno'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=deliverno'),
                array('menu_key'=>'delivering',         'menu_name'=>Language::get('spd_member_path_delivering'),    'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=delivering'),
                array('menu_key'=>'delivered',      'menu_name'=>Language::get('spd_member_path_delivered'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=delivered'),
                );
                break;
            case 'search':
                $menu_array = array(
                1=>array('menu_key'=>'nodeliver',           'menu_name'=>Language::get('spd_member_path_deliverno'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=nodeliver'),
                2=>array('menu_key'=>'delivering',          'menu_name'=>Language::get('spd_member_path_delivering'),    'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=delivering'),
                3=>array('menu_key'=>'delivered',       'menu_name'=>Language::get('spd_member_path_delivered'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreDeliver&a=index&state=delivered'),
                4=>array('menu_key'=>'search',      'menu_name'=>Language::get('spd_member_path_deliver_info'),  'menu_url'=>'###'),
                );
                break;
        }
