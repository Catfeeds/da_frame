...
class PointgradeController extends BasePointShopController {
    ...
    public function index(){
        ...
        $nav_link = array(
                ...
                1=>array('title'=>L('spd_pointprod'),'link'=>urlShop('pointshop','index')),
                2=>array('title'=>'我的成长进度')
        );
        $this->assign('nav_link_list', $nav_link);
        $this->render('pointgrade');
    }
    /**
     * 经验明细列表
     */
    public function exppointlog(){
        ...
        $this->assign('show_page', $model_exppoints->showpage(5));
        ...
        $this->assign('nav_link_list', $nav_link);
        $this->render('point_exppointslog');
    }
}
