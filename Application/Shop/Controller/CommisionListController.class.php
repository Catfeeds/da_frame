...
class CommisionListController extends BaseSellerController {
	...
	public function index() {
	   ...
	   if(trim($_POST['commision_level']) != ''){
			...
			$this->assign('commision_level',$_POST['commision_level']);
		}
	   ...
	   $this->assign('show_page',$model_mingxi->showpage());
	   $this->render('commision_list');
	}
