...
class StatisticsSaleController extends BaseSellerController {
    ...
    public function sale(){
        ...
        $this->assign('stattype',$search_type);
        //总数统计
        ...
        $statcount_arr['orderamount'] = daPriceFormat(($t = floatval($statcount_arr['orderamount'])) > 0?$t:0);
    ...
    public function salelist(){
        ...
        $this->assign('show_page',$model->showpage(2));
        $this->assign('actionurl',"{$GLOBALS['_PAGE_URL']}&c={$this->search_arr['c']}&a={$this->search_arr['a']}&order_type={$this->search_arr['order_type']}&t={$this->search_arr['t']}");
        $this->render('stat.listandorder','null_layout');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'sale','menu_name'=>'销售统计','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsSale&a=sale'),
            2=>array('menu_key'=>'area','menu_name'=>'区域分布','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsSale&a=area'),
            3=>array('menu_key'=>'buying','menu_name'=>'购买分析','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsSale&a=buying'),
        );
