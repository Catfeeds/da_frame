...
class StatisticsIndustryController extends BaseSellerController{
    ...
    private function profile_menu($menu_key=''){
        $menu_array = array(
            1=>array('menu_key'=>'hot','menu_name'=>'同行热卖','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsIndustry&a=hot'),
            2=>array('menu_key'=>'price','menu_name'=>'行业价格分布','menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsIndustry&a=price')
        );
