...
class StorePromotionBookController extends BaseSellerController {
    ...
    public function book_list() {
        ...
        if (checkPlatformStore()) {
            ...
            $this->assign('book_quota', $book_quota);
            if (!empty($book_quota)) {
                $hasList = true;
            }
        }
        ...
        $this->render('store_promotion_book.goods_list');
    }

    /**
     * 购买套餐
     */
    public function book_quota_add() {
        if (chksubmit()) {
        ...
        $this->render('store_promotion_book.quota_add');
    }
     ...
     * 选择商品
     */
    public function book_select_goods() {
        ...
        $this->render('store_promotion_book.select_goods', 'null_layout');
    }
    ...
    public function choosed_goods() {
        ...
        $this->render('store_promotion_book.choosed_goods', 'null_layout');
    }
