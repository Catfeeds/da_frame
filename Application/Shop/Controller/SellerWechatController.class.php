...
class SellerWechatController extends BaseSellerController {
    ...
    */
    ...
    function message_index()
    {
    	...
    	//$this->_curlocal('微信管理',url('app=wechat&c=MessageIndex'),'消息自动回复');
