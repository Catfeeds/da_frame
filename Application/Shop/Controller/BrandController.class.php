...
class BrandController extends BaseHomeController {
    public function index(){
        ...
        $this->assign('html_title',Language::get('brand_index_brand_list'));
    ...
    public function lists(){
        ...
        if(!$brand_info){
            showMessage($lang['wrong_argument'],"{$GLOBALS['_PAGE_URL']}",'html','error');
        }
		$this->assign('brand_int',$brand_info);
