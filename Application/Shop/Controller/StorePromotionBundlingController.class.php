...
class StorePromotionBundlingController extends BaseSellerController {
    ...
    public function bundling_list() {
        ...
        if ($hasList) {
            ...
            $this->assign('show_page',$model_bundling->showpage(2));
        ...
        $this->render('store_promotion_bundling.list');
    }
    ...
    public function bundling_quota_add() {
        ...
        $this->render('store_promotion_bundling.quota_add');
    }
    ...
    public function bundling_add() {
        ...
        if (chksubmit()) {
            ...
            if (!$return) {
                showDialog(L('spd_common_op_fail'), '', '', 'error');
            }
            ...
            if (!empty($_POST['goods']) && is_array($_POST['goods'])) {
                foreach ($_POST['goods'] as $key => $val) {
                    ...
                    $data['bl_goods_price'] = daPriceFormat($val['price']);
            ...
            showDialog(L('spd_common_op_succ'), urlShop('store_promotion_bundling', 'bundling_list'), 'succ');
        }
        ...
        $this->render('store_promotion_bundling.add');
    }
    ...
    public function bundling_add_goods() {
        ...
        $this->render('store_promotion_bundling.add_goods', 'null_layout');
    }
