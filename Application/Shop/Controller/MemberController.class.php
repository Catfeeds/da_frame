...
class MemberController extends BaseMemberController{
    ...
    public function ajax_load_member_info() {
        ...
        $this->render('member_home.member_info','null_layout');
    }
    ...
    public function ajax_load_order_info() {
        ...
        $this->render('member_home.order_info','null_layout');
    }
    ...
    public function ajax_load_goods_info() {
        ...
        if (!empty($favorites_list) && is_array($favorites_list)){
            ...
            $this->assign('favorites_list',$goods_list);
        }
        ...
        if (!empty($favorites_list) && is_array($favorites_list)){
            ...
            $this->assign('favorites_store_list',$store_list);
        }
        ...
        $this->render('member_home.goods_info','null_layout');
    }
    ...
    public function ajax_load_sns_info() {
        ...
        $this->render('member_home.sns_info','null_layout');
    }
}
