...
class StoreMsgController extends BaseSellerController {
    ...
    public function sys_list() {
        ...
        $this->assign('msg_list',$message_array);

        $this->profile_menu('sys_list');
        $this->render('store_msg_sys.list');
    }
    ...
    public function msg_info() {
        ...
        $this->render('store_msg.info', 'null_layout');
    }
    ...
    public function edit_msg_setting() {
        ...
        $this->render('store_msg.setting_edit','null_layout');
    }
