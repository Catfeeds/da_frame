...
class StoreComplainController extends BaseSellerController{
    //定义投诉状态常量
    const STATE_NEW = 10;
    ...
    public function appeal_save() {
        ...
        showDialog(Language::get('appeal_submit_success'),$GLOBALS['_PAGE_URL'] . '&c=StoreComplain','succ');
    }
    ...
    public function apply_handle() {
        ...
        showMessage(Language::get('handle_submit_success'),$GLOBALS['_PAGE_URL'] . '&c=StoreComplain');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            array('menu_key'=>'complain_accused_list','menu_name'=>Language::get('complain_manage_title'),'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreComplain')
        );
