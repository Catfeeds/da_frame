...
class StoreTransportController extends BaseSellerController {
    ...
    public function __construct(){
        ...
        $this->assign('goods_fee_array', $goods_fee_array);
        ...
        $this->assign('goods_trans_array', $goods_trans_array);
    }
    ...
    public function lists(){
        ...
        $this->render('store_transport.list');
    }
    ...
    public function add(){
        ...
        self::profile_menu('transport','transport');
        $this->render('store_transport.add');
    }
    ...
    public function edit(){
        ...
        self::profile_menu('transport','transport');
        $this->render('store_transport.edit');
    }
    ...
    public function save(){
        ...
        if ($result){
            header("location: {$GLOBALS['_PAGE_URL']}&c=StoreTransport&type=".$_POST['type']);exit;
        }else{
            showMessage(Language::get('transport_op_fail'),getReferer(),'html','error');
        }
    }
    ...
    public function offpay_area()
    {
        ...
        $this->render('store_transport.offpay_area');
    }
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            ...
            case 'offpay_area':
                $menu_array = array(
                1=>array('menu_key'=>'transport',   'menu_name'=>Language::get('spd_member_path_postage'),       'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StoreTransport'),
                );
                if (checkPlatformStore()) {
                    $menu_array[] = array(
                        'menu_key' => 'offpay_area',
                        'menu_name' => '货到付款地区',
                        'menu_url' => $GLOBALS['_PAGE_URL'] . '&c=StoreTransport&a=offpay_area'
                    );
                }
                break;
        }
