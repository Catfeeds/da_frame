...
class StatisticsGeneralController extends BaseSellerController {
    ...
    public function general(){
        ...
        $statnew_arr['avgorderamount'] = daPriceFormat(($t = $stat_order['avgorderamount'])?$t:(0));
        unset($stat_order);
        ...
        $statnew_arr['avggoodsprice'] = daPriceFormat(($t = $stat_ordergoods['avggoodsprice'])?$t:(0));
    ...
    public function orderprange(){
        ...
        $this->render('stat.orderpricerange');
    }
    ...
    /*private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'stat_general','menu_name'=>'店铺概况',    'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGeneral&a=general')
        );
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'setting':
                $menu_array = array(
                    1=>array('menu_key'=>'pricesetting','menu_name'=>'商品价格区间',    'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGeneral&a=pricesetting'),
                    2=>array('menu_key'=>'orderprange','menu_name'=>'订单金额区间', 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGeneral&a=orderprange'));
                break;
        }
        $this->assign('member_menu',$menu_array);
        $this->assign('menu_key',$menu_key);
