...
class StorePromotionBoothController extends BaseSellerController {
    ...
    public function index() {
        $this->booth_goods_list();
    }

    /**
     * 套餐商品列表
     */
    public function booth_goods_list() {
        ...
        $this->render('store_promotion_booth.goods_list');
    }
    ...
    public function booth_select_goods() {
        ...
        $this->render('store_promotion_booth.select_goods', 'null_layout');
    }
    ...
    public function booth_quota_add() {
        ...
        $this->render('store_promotion_booth.quota_add');
    }
