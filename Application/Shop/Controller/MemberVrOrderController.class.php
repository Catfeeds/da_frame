...
class MemberVrOrderController extends BaseMemberController {
    ...
    public function index() {
        ...
        $this->render('member_vr_order.index');
    }
    ...
    public function show_order() {
        ...
        $this->render('member_vr_order.show');
    }
    ...
    private function _order_cancel($order_info, $post) {
        if (!chksubmit()) {
            $this->assign('order_info', $order_info);
            $this->render('member_vr_order.cancel','null_layout');
            exit();
        } else {
            $model_vr_order = Model('vr_order');
    ...
    public function resend() {
        if (!chksubmit()) {
            $this->render('member_vr_order.resend','null_layout');exit();
        }
    ...
    private function profile_menu($menu_key='') {
        ...
        $menu_array = array(
            array('menu_key'=>'member_order','menu_name'=>Language::get('spd_member_path_order_list'), 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=MemberVrOrder'),
        );
