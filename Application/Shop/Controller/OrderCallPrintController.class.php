...
class OrderCallPrintController extends BaseSellerController {
	...
	public function index() {
        ...
        foreach ($order_list as $key => $order_info) {
        	...
        	foreach ($order_info['extend_order_goods'] as $value) {
				...
				$value['goods_all_price'] = daPriceFormat($value['goods_num'] * $value['goods_price']);
		...
		$this->render('order_call.print',"null_layout");
	...
	public function small() {
		...
		$this->render('order_small.print',"null_layout");
        //$this->render('order_call.index');
