...
class OrderCallController extends BaseSellerController {
    ...
    private function profile_menu($menu_type='',$menu_key='') {
        ...
        switch ($menu_type) {
        	case 'list':
            $menu_array = array(
            array('menu_key'=>'order_call',		'menu_name'=>Language::get('spd_member_path_all_order'),	'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=OrderCall'),
