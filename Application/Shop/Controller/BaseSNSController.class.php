...
class BaseSNSController extends BaseController {
	...
	public function get_member_info() {
		...
		if(empty($member_info)){
			$url = url('member_snshome', '', array());
			showMessage(L('wrong_argument'), $url, '', 'error');
		}
		//粉丝数
	...
	private function add_visit(){
		...
		if ($is_increase == true){
			...
			setDaCookie('visitor',implode('_',$cookie_arr),24*3600);//保存24小时
		}
	}
	//我的关注
