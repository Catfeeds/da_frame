...
class CompareController extends BaseHomeController{
    ...
    public function addcompare(){
        ...
        setDaCookie('comparegoods', $comparegoods_str);
    ...
    public function showcompare(){
        ...
        if($gid_arr){
            ...
            if ($goods_listtmp){
                ...
                //更新cookie数据
                setDaCookie('comparegoods', $goodsid_arr?implode(',',$goodsid_arr):'');
            } else {
                //更新cookie数据
                setDaCookie('comparegoods','',-3600);
            }
        }
        $this->assign('goodsid_str',$goodsid_arr?implode(',',$goodsid_arr):'');
        $this->assign('compare_list', $compare_list);
        $this->assign('freemaxnum', self::MAXNUM - count($compare_list));
        $this->render('compare_mini','null_layout');
    }
    /**
     * 获得已加入对比的商品ID
     */
    ...
    public function delcompare(){
        ...
        //更新cookie数据
        if($gid_str){
            setDaCookie('comparegoods', $gid_str);
        } else {
            setDaCookie('comparegoods','',-3600);
        }
