...
class StoreChainController extends BaseSellerController {
    private $model_chain;
    ...
    public function chain_list() {
        ...
        $this->assign('show_page', $this->model_chain->showpage());
        $this->assign('chain_list', $chain_list);
        $this->profile_menu('chain_list', 'chain_list');
        $this->render('store_chain.list');
    }
