...
class StoreNavigationController extends BaseSellerController {
    ...
    public function navigation_list() {
        ...
        $this->render('store_navigation.list');
    }

    public function navigation_add() {
        $this->profile_menu('navigation_add');
        $this->render('store_navigation.form');
    }
    ...
    public function navigation_save() {
        ...
        showDialog(L('spd_common_op_succ'), urlShop('store_navigation', 'navigation_list'), 'succ');
    }
    ...
    public function navigation_del() {
        ...
        if($sn_id > 0) {
            ...
            showDialog(L('spd_common_op_fail'), urlShop('store_navigation', 'navigation_list'), 'error');
        }
    }
