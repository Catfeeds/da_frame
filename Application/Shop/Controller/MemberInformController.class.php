...
class MemberInformController extends BaseMemberController{
    ...
    public function inform_list() {
        ...
        $this->render('member_inform.list');
    }
    ...
    public function inform_submit() {
        ...
        $this->render('member_inform.submit');
    }
    ...
    public function inform_save() {
        ...
        if($model_inform->saveInform($input)) {
            showDialog(Language::get('inform_success'),$GLOBALS['_PAGE_URL'] . '&c=MemberInform&a=inform_list','succ');
        }
        else {
            showDialog(Language::get('inform_fail'),$GLOBALS['_PAGE_URL'] . '&c=MemberInform&a=inform_list','error');
        }
    }
    ...
    public function inform_info() {
        ...
        $this->render('member_inform.info');
    }
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'inform_list','menu_name'=>'违规举报', 'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=MemberInform&a=inform_list'),
        );
