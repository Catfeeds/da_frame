...
use Shop\Controller\BaseGoodsController;
...
class GoodsController extends BaseGoodsController {
    ...
    public function index() {
        ...
        if ($goods_info['is_book'] == 1) {
            if ( $goods_info['book_down_time'] < TIMESTAMP ) {
                ...
                $this->assign('remain', array('day' => $remain_day, 'hour' => $remain_hour, 'minute' => $remain_minute));
            }
        }
    ...
    public function comments() {
        ...
        $this->render('goods.comments','null_layout');
    }
    ...
    public function comments_list() {
        ...
        $this->render('goods.comments_list');
    }
    ...
    private function _get_comments($goods_id, $type, $page) {
        ...
        $this->assign('show_page',$model_evaluate_goods->showpage('5'));
    }
    ...
    public function salelog() {
        ...
        $this->assign('order_type', array(1=>'原价', 2=>'抢购', 3=>'折扣', 4=>'套装', 5=>'赠品', 8=>'原价', 9=>'换购'));
        $this->assign('order_vr_type', array(0=>'原价', 1=>'抢购'));
        
        $this->render('goods.salelog','null_layout');
    }
    ...
    public function consulting() {
        ...
        $this->render('goods.consulting', 'null_layout');
    }
    ...
    public function consulting_list() {
        ...
        $this->assign('consult_list',$consult_list);
        $this->assign('show_page', $model_consult->showpage());
        ...
        $this->render('goods.consulting_list');
    }
    ...
    public function save_consult(){
        ...
        if (Process::islock('commit')){
            showDialog(L('spd_common_op_repeat'));
        }else{
    ...
    public function get_bundling() {
        ...
        $this->render('goods_bundling', 'null_layout');
    }
    ...
    public function arrival_notice() {
        ...
        $this->render('arrival_notice.submit', 'null_layout');
    }
    ...
    public function arrival_notice_succ() {
        ...
        $this->render('arrival_notice.message', 'null_layout');
    }
    ...
    public function show_chain() {
        ...
        if (!empty($stock_list)) {
            ...
            $this->assign('chain_list', json_encode($chain_list));
        }
        $this->render('goods.show_chain', 'null_layout');
    }
}
