...
class StatisticsGoodsController extends BaseSellerController {
    ...
    public function __construct(){
        ...
        //处理搜索时间
        if (in_array($this->search_arr['a'],array('price','hotgoods'))){
    ...
    public function goodslist(){
        ...
        $this->render('stat.goods.goodslist');
    }
    ...
    public function goodsinfo(){
        ...
        if ($goods_id <= 0){
            ...
            $this->render($templatesname,'null_layout');
        }
        //查询商品信息
        ...
        $stat_count['ordergamount'] = daPriceFormat($stat_count['ordergamount']);
    ...
    private function profile_menu($menu_key='') {
        $menu_array = array(
            1=>array('menu_key'=>'goodslist','menu_name'=>'商品详情',   'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGoods&a=goodslist'),
            2=>array('menu_key'=>'price','menu_name'=>'价格销量',   'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGoods&a=price'),
            3=>array('menu_key'=>'hotgoods','menu_name'=>'热卖商品',    'menu_url'=>$GLOBALS['_PAGE_URL'] . '&c=StatisticsGoods&a=hotgoods'),
        );
