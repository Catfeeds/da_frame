...
class ManageController extends BaseCircleManageController {
    ...
    public function index(){
        ...
        if($this->identity == 2){
            @header("location: ".CIRCLE_SITE_URL.'&c=Manage&a=applying&c_id='.$this->c_id);
        }
        // 会员加入圈子列表
        ...
        $this->assign('ml_info', $ml_info);

        $this->sidebar_menu('index');
        $this->render('group_manage_index');
    }
    /**
     * 成员管理
     */
    public function member_manage(){
        ...
        $this->assign('cm_list', $cm_list);

        $this->sidebar_menu('member');
        $this->render('group_manage_member');
    }
    /**
    ...
    public function delmember(){
        ...
        $this->render('group_manage_memberdel', 'null_layout');
    }
    /**
     * 设置/取消管理
     */
    ...
    public function applying(){
        ...
        $this->render('group_manage_memberapplying');
    }
    /**
     * 申请中成员操作
     */
    public function applying_manage(){
        // 身份验证
    ...
    public function classes(){
        ...
        $this->render('group_manage_class');
    }
    /**
     * 分类添加
     */
    public function class_add(){
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                showDialog(L('spd_common_op_succ'), 'reload', 'succ', 'CUR_DIALOG.close();');
            }
        }
        $this->render('group_manage_classadd', 'null_layout');
    }
    /**
     * 分类编辑
     */
    public function class_edit(){
        ...
        $this->assign('thclass_info', $thclass_info);
        $this->render('group_manage_classedit', 'null_layout');
    }
    /**
     * 删除分类
     */
    ...
    public function friendship(){
        ...
        $this->assign('fs_list', $fs_list);

        $this->sidebar_menu('friendship');
        $this->render('group_manage_fs');
    }
    /**
     * 添加友情圈子
     */
    public function friendship_add(){
        ...
        $this->render('group_manage_fsadd', 'null_layout');
    }
    /**
     * ajax根据名称搜索
     */
     ...
     * 编辑圈子
     */
    public function friendship_edit(){
        // 身份验证
        $rs = $this->checkIdentity('c');
        if(!empty($rs)){
            showDialog($rs);
        ...
        $this->assign('fs_id', $fs_id);
        $this->assign('friendship_info', $friendship_info);

        $this->render('group_manage_fsedit', 'null_layout');
    }
    /**
     * 删除友情圈子
     */
    public function friendship_del(){
        // 身份验证
        $rs = $this->checkIdentity('c');
        if(!empty($rs)){
            showDialog($rs);
    ...
    public function edit_theme(){
        ...
        if(chksubmit()){
            ...
            if($rs){
                ...
                showDialog(L('spd_common_op_succ'), CIRCLE_SITE_URL.'&c=Theme&a=theme_detail&c_id='.$this->c_id.'&t_id='.$t_id, 'succ');
            }else{
        ...
        if($this->theme_info['theme_special'] == 1){
            ...
            $this->render('group_manage_edit_themepoll');
        }else{
            $this->render('group_manage_edit_theme');
        }
    }
    /**
     * 附件删除
    ...
    public function del_theme(){
        ...
        showDialog(L('spd_common_op_succ'), CIRCLE_SITE_URL.'&c=Group&c_id='.$this->c_id, 'succ');
    }
    /**
     * 删除回复
     */
