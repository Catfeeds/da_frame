...
class ManageLevelController extends BaseCircleManageController {
    ...
    public function level(){
        ...
        if (!empty($mldefault_list)){
            ...
            $this->assign('mlr_array',$mlr_array);
        }
        ...
        if(!empty($ml_info)){
            ...
            $this->assign('ml_info', $ml_array);
        }

        $this->sidebar_menu('level');
        $this->render('group_manage_memberlevel');
    }
}
