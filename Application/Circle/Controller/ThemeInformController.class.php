...
class ThemeInformController extends BaseCircleController {
    ...
    public function index(){
        ...
        if(chksubmit()){
            ...
            showDialog(L('spd_common_op_succ'), '', 'succ', '$(\'a[datype="inform_cancel"]\').click();');
        }
        $this->assign('t_id', $t_id);
        $this->render('theme.inform','null_layout');
    }
}
