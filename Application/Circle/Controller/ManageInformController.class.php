...
class ManageInformController extends BaseCircleManageController {
    ...
    public function inform(){
        ...
        if (chksubmit()){
            ...
            foreach ($_POST['i_id'] as $val){
                ...
                $update['inform_opresult']  = $_POST['i_result'][$val] == ''? L('spd_nothing') : $_POST['i_result'][$val];
        ...
        $_GET['type'] == 'treated' ? $this->render('group_manage_inform.treated') : $this->render('group_manage_inform.untreated');
    }
