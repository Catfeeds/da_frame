...
class IndexController extends BaseCircleController {
    ...
    public function index(){
        ...
        if(!empty($circle_list)){
            ...
            if(!empty($nowthemecount_array)){
                ...
                $this->assign('nowthemecount_array', $nowthemecount_array);
            }
            ...
            if(!empty($nowjoincount_array)){
                ...
                $this->assign('nowjoincount_array', $nowjoincount_array);
            }
        }
        ...
        $this->assign('rcircle_list', $rcircle_list);
        ...
        if(!empty($gtheme_list)){
            ...
            $this->assign('thg_list', $thg_list);

            $this->assign('gtheme_list', $gtheme_list);
        }
        ...
        if(!empty($member_list)){
            ...
            $this->assign('one_member', $one_member);
            $this->assign('one_membertheme', $one_membertheme);
        ...
        if(chksubmit()){
            ...
            if($error != ''){
                ...
                if($result){
                    ...
                    showDialog(L('spd_common_op_succ'),$GLOBALS['_PAGE_URL'] . '&c=Group&c_id='.$result, 'succ');
                }else{
                    showDialog(L('spd_common_op_fail'));
                }
            }
        }
        $this->assign('create_count', $create_count);
     ...
     * 我加入的圈子
     */
    public function myjoinedcircle(){
