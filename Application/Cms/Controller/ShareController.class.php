...
class ShareController extends CMSController{
    ...
    public function share_save() {
        ...
        $share_type = convert_word_underscore($share_type);
        ...
        if(!empty($_SESSION['member_id'])) {
            ...
            if(isset($_POST['share_app_items'])) {
                ...
                $info['url'] = CMS_SITE_URL."&c={$_GET['type']}&a={$_GET['type']}_detail&{$_GET['type']}_id=".$_POST['share_id'];
