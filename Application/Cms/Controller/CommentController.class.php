...
class CommentController extends CMSHomeController{
    ...
    public function comment_save() {
        ...
        $comment_type = convert_word_underscore($_POST['comment_type']);
        $model_name = '';
        $count_field = '';
        switch ($comment_type) {
        case 'article':
    ...
    public function comment_list() {
        ...
        if($comment_object_id > 0 && $comment_type > 0) {
            ...
            //var_dump($condition, $page_count, $order, $comment_list);
            //exit;
            
            
            $this->assign('comment_list', $comment_list);
            if($_GET['comment_all'] === 'all') {
                $this->assign('show_page', $model_cms_comment->showpage(2));
            }
            ...
            $this->assign('comment_quote_list', $comment_quote_list);
            $this->render('comment_list','null_layout');
        }
    }
