...
class sns_bindingModel extends Model{
    ...
    public function getApps(){
        $app_arr = array();
        $app_arr['qqweibo'] = array('name'=>Language::get('spd_shareset_qqweibo'),'url'=>"http://t.qq.com",'applyurl'=>'http://dev.t.qq.com');
        $app_arr['sinaweibo'] = array('name'=>Language::get('spd_shareset_sinaweibo'),'url'=>"http://www.weibo.com",'applyurl'=>'http://open.weibo.com/developers');
        return $app_arr;
    }
    /**
    ...
    public function addQQWeiboPic($bindinfo,$params){
        ...
        require_once(BASE_ROOT_PATH.DS.'Api'.DS.'snsapi'.DS.'qqweibo'.DS.'tencent.php');
    ...
    public function addSinaWeiboUpload($bindinfo,$params){
        require_once(BASE_ROOT_PATH.DS.'Api'.DS.'snsapi'.DS.'sinaweibo'.DS.'config.php');
