...
class predepositModel extends Model {
    ...
    public function changeRcb($type, $data = array())
    {
        ...
        $msg = array(
            ...
            'param' => array(
                ...
                'available_amount' => daPriceFormat($available),
                'freeze_amount' => daPriceFormat($freeze),
                'description' => $desc,
            ),
        );
    ...
    public function changePd($change_type,$data = array()) {
        ...
        $data_msg['av_amount'] = daPriceFormat($data_msg['av_amount']);
        $data_msg['freeze_amount'] = daPriceFormat($data_msg['freeze_amount']);
