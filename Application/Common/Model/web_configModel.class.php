...
class web_configModel extends Model{
    ...
    public function updateWebHtml($web_id = 1,$web_array = array()){
        ...
        if(!empty($code_list) && is_array($code_list)) {
            Language::read('web_config,home_index_index', 'Home');
            ...
            switch ($web_page) {
                case 'index':
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'default.php';
                    break;
                case 'index_pic':
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'focus.php';
                    break;
                case 'index_sale':
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'sale_goods.php';
                    break;
                case 'channel_tp':
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'channel_top.php';
                    break;
                case 'channel_fl':
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'channel_floor.php';
                    break;
                default:
                    $style_file = COMMON_RESOURCE_PATH . DS.'web_config'.DS.'default.php';
                    break;
