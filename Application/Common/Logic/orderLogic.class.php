	...
	public function addInviteRate($order_info){
			...
			//取得拥金金额
			 ...
			 if($commis_amount_sum>0) {
				  ...
				  $im_arr=explode('.',$commis_amount_sum * $GLOBALS['setting_config']['shopda_invite2']*0.01);
				  $invite_money2 = $im_arr[0].'.'.substr($im_arr[1],0,2);
				  $im_arr=explode('.',$commis_amount_sum * $GLOBALS['setting_config']['shopda_invite3']*0.01);
