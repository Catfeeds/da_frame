...
class goodsLogic {
    ...
    public function __construct() {
        Language::read('member_store_goods_index', 'Home');
    }
    ...
    private function _initCommonGoodsByParam($param, $store_id, $store_name, $store_state) {
        ...
        $common_array['goods_trans_v']      = floatval($param['goods_trans_v']);// shopda
    ...
    private function _initGoodsByCommonGoods($common_id, $common_array) {
        ...
        $goods['goods_trans_v']     = $common_array['goods_trans_v'];//  shopda
