 ...
 */
(function($) {
    $.fn.spd_text_count = function(options,submit_function) {
        var settings = $.extend({}, {max: 140}, options);
        return this.each(function() {
            $(this).after('<span spd_type="commend_count"></div>');
            var message_item = $(this).next("[spd_type='commend_count']");
 ...
 */
;(function($) {
    $.fn.spd_gallery = function(options) {
