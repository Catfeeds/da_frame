...
(function($) {
    $.fn.microshop_publish = function(options,submit_function) {
        ...
        $(this).after('<span id="_comment_count" spd_type="commend_count" class="commend_count"></div>');
        settings.message_item = $(this).next("[spd_type='commend_count']");
...
(function($) {
    $.fn.microshop_like = function(options) {
        ...
        function submit_like() {
            var item = $(this);
            $.getJSON(_PAGE_URL + "&c=Like&a=like_save", { type: settings.type, like_id: item.attr("like_id") }, function(json){
                if(json.result == "true") {
