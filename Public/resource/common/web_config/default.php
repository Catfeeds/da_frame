...
<div class="home-standard-layout wrapper style-<?php echo $output['style_name'];?>">
  ...
  <ul class="right-brand">
        ...
        <li>
          <a href="<?php echo urlShop('brand', 'lists', array('brand'=> $val['brand_id'])); ?>" title="<?php echo $val['brand_name']; ?>" target="_blank"><?php echo $val['brand_name']; ?></a>
        </li>
                  <?php } ?>
                  <?php } ?>
                   <li>
          <a href="<?php echo BASE_SITE_URL;?>?&c=Brand&a=index" title="" target="_blank">更多</a>
        </li>
            </ul>
    ...
    <div class="tabs-panel middle-spdgoods-list <?php echo $i==1 ? '':'tabs-hide';?>">
      <ul>
        <?php foreach($val['goods_list'] as $k => $v){ ?>
        <li>
          <dl>
            <dt class="spdgoods-name"><a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id'])); ?>" title="<?php echo $v['goods_name']; ?>"> <?php echo $v['goods_name']; ?></a></dt>
            <dd class="spdgoods-thumb"> <a target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $v['goods_id'])); ?>"> <img src="<?php echo strpos($v['goods_pic'],'http')===0 ? $v['goods_pic']:UPLOAD_SITE_URL."/".$v['goods_pic'];?>" alt="<?php echo $v['goods_name']; ?>" /> </a></dd>
            <dd class="spdgoods-price"><em><?php echo daPriceFormatForList($v['goods_price']); ?></em> <span class="original"><?php echo daPriceFormatForList($v['market_price']); ?></span></dd>
          </dl>
        </li>
        <?php } ?>
      </ul>
