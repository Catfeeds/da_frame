$(function(){
    ...
    /* 批量操作按钮 */
    $('a[spd_type="batchbutton"]').click(function(){
        /* 是否有选择 */
...
//	        window.location.href=uri + '&' + name + '=' + items;
    ...
    $('*[spd_type="dialog"]').click(function(){
    ...
    $('*[spd_type="gselector"]').focus(function(){
        ...
        ajax_form(id, title, SITEURL + '&c=StoreGroupbuy&a=' + op + '&dialog=1&title=' + title + '&store_id=' + store_id+ '&id=' + id + '&name=' + name + '&callback=' + callback, width);
        return false;
    });
    ...
    $('span[spd_type="order_by"]').each(function(){
    ...
    $('span[spd_type="order_by"]').click(function(){
